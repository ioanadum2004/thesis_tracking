...
*   **`estimatedparameters.root`**: Contains the estimated track parameters (e.g., initial pT, direction) for each seed candidate directly after the seeding stage, before they 
are processed by the ML filter or CKF.
